...
def main():
    '''
    python train_dcan_fourier.py [num_gpu] [batch_size] [dataset_name] [img_shape] [model_shape] [stride] [bnd_dilate] [model_name]
    or
    python train_dcan_fourier.py [num_gpu] [batch_size] [dataset_name] [model_name]
    '''
    ...
    mask_map = NullMapGenerator('mask_fourier_map')
    bnd_map = NullMapGenerator('bnd_weight_map')
    ...
    train_generator = LambdaGenerator(train_generator, [train_normalization, weight_map, fd_generator_train])
